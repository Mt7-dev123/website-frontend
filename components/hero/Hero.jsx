...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* CONTENT CONTAINER */}
      {/* <div className="relative z-10 w-full max-w-[1400px] px-14 flex items-center justify-between">
        <motion.div
          initial={{ y: 40, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ delay: 0.3, duration: 0.9, ease: "easeOut" }}
          className="max-w-xl"
        >
          <h1 className={`${montserrat.className} text-4xl font-extrabold leading-tight bg-gradient-to-r from-white via-[#ffae42] to-[#ff4500] bg-clip-text text-transparent`}>
            Your Business, <br /> Our Network.
          </h1>
        </motion.div>
      </div> */}
