...
//                   <motion.button
//                     type="submit"
//                     className="px-8 py-3 bg-red-600 text-white font-bold rounded-xl hover:bg-red-500 transition-all flex items-center justify-center gap-2 group shadow-lg shadow-red-900/20 whitespace-nowrap"
...
//         body: JSON.stringify({
//           access_key: "YOUR_WEB3FORMS_ACCESS_KEY", //Ronit add your access key here
//           name: formData.name,
//           email: formData.email,
//           subject: "New Newsletter Subscription from MT7.in",
//         }),
//       });
...
//   return (
//     <footer className="relative bg-transparent pt-10 pb-6 overflow-hidden">
//       <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-red-500/40 to-transparent" />
//       <div className="absolute inset-0 overflow-hidden pointer-events-none">
//         <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-red-500/5 rounded-full blur-[120px] opacity-20" />
//       </div>
...
//                 required
//                 className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-red-500 transition-all"
//               />
//               <input
//                 type="email"
//                 name="email"
...
//                 className="w-full sm:w-auto px-8 py-3 bg-red-600 text-white font-bold rounded-xl hover:bg-red-500 transition-all flex items-center justify-center gap-2 group shadow-lg shadow-red-900/20 disabled:opacity-50"
...
//               +1 (555) 123-4567
//             </a>
//             <a href="mailto:contact@mt7.in" className="flex items-center gap-2 hover:text-white">
//               <Mail size={14} className="text-red-500" />
//               contact@mt7.in
//             </a>
//           </div>
...
//previous design with proper alignment 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-14">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <motion.button
                    type="submit"
                    className="px-8 py-3 bg-red-600 text-white font-bold rounded-xl hover:bg-red-500 transition-all flex items-center justify-center gap-2 group shadow-lg shadow-red-900/20 sm:ml-auto"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    Subscribe
            ...
            <div className="lg:col-span-5 grid grid-cols-3 gap-4 lg:gap-8">
              {Object.entries(footerLinks).map(([category, links]) => (
                <div key={category}>
                  <h3 className={`${montserrat.className} text-white font-bold text-[10px] sm:text-xs uppercase tracking-widest mb-6`}>
                    {category}
                  </h3>
                  <ul className="flex flex-col gap-4">
                    {links.map((link) => (
                      <li key={link.label}>
                        <Link
                          href={link.href}
                          className="text-gray-400 hover:text-white text-[11px] sm:text-sm transition-colors relative group"
                        >
                          {link.label}
                          <span className="absolute left-0 -bottom-1 w-0 h-[1px] bg-red-500 group-hover:w-full transition-all duration-300" />
                        </Link>
