...
import { ArrowRight, CheckCircle2, Layers, ShieldCheck, Clock } from "lucide-react";
    ...
    >
      ...
      <div className="relative z-30 w-full max-w-[1300px] px-6 md:px-14">
        ...
        <div className="flex flex-col items-start md:-mt-5 max-w-3xl mb-16">
          ...
          <p className={`${montserrat.className} text-zinc-400 text-sm md:text-base leading-relaxed`}>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-20">
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className={`${montserrat.className} text-xl font-bold text-white`}>The Problem We Saw</h3>
            </div>
            <p className={`${montserrat.className} text-zinc-400 text-sm leading-relaxed mb-5`}>
              Every startup we talked to had the same pain. Founders were spending more time managing vendors than building their business.
            </p>
            <ul className="space-y-3">
              {[
                ...
                <li key={idx} className="flex items-start gap-3 text-zinc-300 text-xs md:text-sm">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className={`${montserrat.className} text-xl font-bold text-white`}>Our Solution</h3>
            </div>
            
            <p className={`${montserrat.className} text-zinc-400 text-sm leading-relaxed mb-5`}>
              Mt7 is not an agency or a marketplace. We are a business operations system acting as your single operational manager.
            </p>
        ...
        <div className="mb-20">
            <div className="text-center mb-10">
              <h3 className={`${montserrat.className} text-2xl md:text-3xl font-bold text-white mb-4`}>Our Approach</h3>
              <p className={`${montserrat.className} text-zinc-400 text-sm md:text-base max-w-2xl mx-auto`}>
                The "7 Layers" represent our systematic approach to covering every operational need of your business.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                >
                  ...
                  <h4 className="text-white font-bold text-lg mb-3">{domain.title}</h4>
                  <div className="flex flex-wrap justify-center gap-2">
                    {domain.items.map(tag => (
                      <span key={tag} className="text-[10px] px-2.5 py-1 rounded-full bg-white/5 text-zinc-400 border border-white/5">
                        {tag}
                      </span>
                    ))}
                  </div>
        ...
        <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-center mb-20 bg-zinc-900/20 p-6 md:p-10 rounded-[1.5rem] border border-white/5">
           ...
           <div className="md:col-span-8">
              <p className="text-orange-500 font-bold tracking-widest text-[10px] mb-2 uppercase">Meet The Founder</p>
              <h3 className={`${montserrat.className} text-2xl md:text-3xl font-bold text-white mb-2`}>Abdul Adnan</h3>
              <p className="text-zinc-500 text-xs md:text-sm mb-6">Founder & CEO</p>
              
              <div className="space-y-4 text-zinc-300 text-sm leading-relaxed font-light">
                <p>
                  Abdul has managed operations for multiple startups across hospitality, e-commerce, SaaS, and AI. He's built systems that scale from ₹0 to ₹10Cr+ revenue.
                </p>
                <p>
                  After watching too many founders waste time on vendor management, he created Mt7 to solve this problem systematically.
                </p>
              </div>
           </div>
        </div>
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={idx} className="p-5 rounded-[1rem] bg-zinc-900/30 border border-white/5 hover:border-orange-500/30 transition-colors">
        ...
        <div className="flex flex-col items-center justify-center text-center pb-10">
          <h2 className={`${montserrat.className} text-2xl md:text-3xl font-bold text-white mb-6`}>
          ...
          <Link href="/consultation">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`${montserrat.className} px-8 py-4 bg-[#ff4500] text-white font-bold text-sm md:text-base rounded-full transition-all shadow-lg shadow-orange-900/20`}
            >
