        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          {STEPS.map((step, index) => (
            <motion.div
              ...
              className="relative group p-8 rounded-[2rem] border border-white/10 bg-zinc-900/40 backdrop-blur-xl flex flex-col"
            >
              <div className="absolute top-6 right-8 text-4xl font-black text-white/5 italic group-hover:text-orange-500/10 transition-colors">
                {step.id}
              </div>
              ...
              <div className="mt-auto pt-6 border-t border-white/5 italic text-xs text-orange-500/80">
                {step.footer}
              </div>
            </motion.div>
          ))}
